				...
				<div class="box12 block ">
					<div class="w-box">
						<div class="w-box-header">
							<div class="pull-left">Month-Year Records [Batch Name: {{ $batchName }} - {{ $batchYear.'/'.$batchMonth.'/'.$batchWeek }}]</div>
							<br/>
							<div style="margin: 1px 0px 0px -11px;">
								<div class="tab active" id="cleansing" style="border-left:1px solid #ddd">Cleansing</div>
								<div class="tab" id="survey">Survey</div>
								<div class="tab" id="ssi">SSI</div>
							</div>
						</div>
								...
								<div class="span12">
									...
									<table cellpadding="10px" class="table table-striped table-bordered mediaTable ">
										<thead>
											...
											<tr>
												<td colspan="120" style="height: 52px; padding: 0px; background-color: white;">
											...
											<tr class="ssi" style="display:none">
										...
										<tbody>
											...
											<?php
											if( isset($csdbCustomerMonthYearRaw) ){
												foreach( $csdbCustomerMonthYearRaw  as $file){
											?>											

											<tr class="cleansing" onclick="javascript: location.href='{{ URL::route('editUploadedRecordByCaller', array('id'=>$file->id)) }}' " style="cursor:pointer">
												<td style="text-align:center">{{++$num}}</td>
												<td>{{$file->title}}</td>

												<td><a href="{{ URL::route('editUploadedRecordByCaller', array('id'=>$file->id)) }}"> {{$file->customerName }} </a></td>
											...
											<tr class="survey" style="display:none; cursor:pointer" onclick="javascript: location.href='{{ URL::route('editUploadedRecordByCaller', array('id'=>$file->id)) }}' ">
											...
											<tr class="ssi" style="display:none; cursor:pointer" onclick="javascript: location.href='{{ URL::route('editUploadedRecordByCaller', array('id'=>$file->id)) }}' ">
