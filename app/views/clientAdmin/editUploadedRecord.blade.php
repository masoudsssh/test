				...
				<div class="box12 block ">
					<div class="w-box">
						<div class="w-box-header" style="position:static; border-right:1px solid #ddd">
							...
							?>
							<div class="pull-left">
								Edit Record <?php echo '[Batch Name: '.$file->batchName.']'; ?>								
							</div>						
							<div class="pull-right">
								<?php 	
									if($file->callerID){								
										$user = Sentry::findUserById($file->callerID);
										$open = explode(' ', $file->open_at );
										$close= explode(' ', $file->close_at );
										if(is_object($user)){
											echo 'Caller Fullname: '.$user->first_name.' '.$user->last_name.' [ID='.$file->callerID.', Time='.$open[1].' - '.$close[1].']';
										}
									}
								?>
							</div>
						...
						<div class="w-box-content">
							<div class="row-fluid">
								<div class="span12">
									{{ Form::open(array('url' => URL::route('storeEditUploadedRecordByAdmin') )) }}
