				...
				<div class="box12 block ">
					<div class="w-box">
						<div class="w-box-header">
							<div class="pull-left">Month-Year Records [Batch Name: {{ $batchName }}]</div>
						</div>
									...
									<table cellpadding="10px" class="table table-striped table-bordered mediaTable ">
										<thead>
											...
											<tr>
												...
												<th style="width: 64px; display: block; padding-top: 98px;">Action</th>										
											</tr>
										</thead>
										<tbody>
											<?php $num=0; ?>
											...
											<tr onclick="javascript: location.href='{{ URL::route('editUploadedRecord', array('id'=>$file->id)) }}' " style="cursor:pointer">
												<td style="text-align:center">{{++$num}}</td>
												<td>{{$file->title}}</td>

												<td><a href="{{ URL::route('editUploadedRecord', array('id'=>$file->id)) }}"> {{$file->customerName }} </a></td>
												...
												<td style="text-align:center">
													<button class="btn btn-default">
														<i class="icon-edit" style="margin-top: 1px;"></i> Edit
													</button>
