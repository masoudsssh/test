...
<html lang="en">
    <head>
        ...
        <title>Customer Service DataBase Panel</title>
    ...
    <body class="login_page">
		...
		<div class="login_box">
			...
			<form action="{{URL::route('loginPost')}}" method="post" id="login_form">
				<div class="top_b">Sign in to Customer Service DataBase Panel</div>    
				@if(Session::get("data"))
				...
				<div class="cnt_b">
					<div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-user"></i></span><input type="text" id="email" name="email" placeholder="email" value="" />
						</div>
					</div>
					<div class="formRow">
						<div class="input-prepend">
			...
			<form action="dashboard.html" method="post" id="reg_form" style="display:none">
				<div class="top_b">Sign up to Customer Service DataBase</div>
