				...
				<div class="box12 block ">
					<div class="w-box">
						<div class="w-box-header">
							<?php
								$batchName = CsdbCustomerRaw::where('batchID',$_GET['batchID'])->pluck('batchName');
							?>
							<div class="pull-left">List of Uploaded Files <?php echo '[Batch Name: '.$batchName.']'; ?></div>						
						</div>
								...
								<div class="span12">
									...
									<table cellpadding="10px" class="table table-striped table-bordered mediaTable ">
										...
										<tbody>
											...
											@if($cnt>0)	
											@foreach(CsdbCustomerRaw::where('batchID',$_GET['batchID'])->get() as $file)
